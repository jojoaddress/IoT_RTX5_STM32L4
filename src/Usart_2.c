...
//用于板载USART_2接口
#define USART_Initialization		USART_2_Initialization
#define USART_Thread				USART_2_Thread
#define USART_Send					USART_2_Send
#define USART_Receive				USART_2_Receive
#define USART_Boudrate				USART_2_Boudrate
#define USART_RxBuffer				USART_2_RxBuffer
#define USART_TxBuffer				USART_2_TxBuffer

#define bSending_USART				bSending_USART_2
#define bReceiving_USART			bReceiving_USART_2
#define sem_USART_Send				sem_USART_2_Send
#define sem_USART_Receive			sem_USART_2_Receive
#define USART_callback				USART_2_callback
#define USART_drv					USART_2_drv
